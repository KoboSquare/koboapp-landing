...
const navLinks = [
    ...
    {
        label: "Company", href: "/about-us", children: (
            <div className="grid grid-cols-2 gap-8 p-4">
                ...
                <div className="flex flex-col gap-2 h-full">
                    <Link href="/careers" className="h-[50%] rounded-xl bg-[#0A1B1B] border border-[#B0D0CE] relative">
                        <div className='p-5 flex flex-col gap-1'>
                    ...
                    <Link href="/press" className="h-[50%] rounded-xl border border-[#B0D0CE] relative">
                        <div className='p-5 flex flex-col gap-1'>
                ...
                {navLinks.map((link) =>
                    link.children ? (
                        ...
                        <Link href={link.href} key={link.label}>
                            <Button variant='subtle' color="white">{link.label}</Button>
                        </Link>
                    )
                )}
            </div>
