    ...
    return (
        <main>
            ...
            <div className='mt-4 mb-16'>
                ...
                <Image src={mapImage} priority alt='kobo-map' className='w-full h-full object-cover' />
